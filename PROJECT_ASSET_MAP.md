...
| RECON/HuRoN CONVERSION-PILOT | 两个隔离 processed pilot、receipt、内容/尺度审计和 train-only group-safe manifest 通过；RECON 逐帧时间戳与两者 policy/version 缺失，未晋级 | `results/research/data_conversion/recon_huron_pilot_20260720/audit.md` |
