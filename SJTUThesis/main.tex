...
% 载入 SJTUThesis 模版
\documentclass[type=bachelor,preset=jwc]{sjtuthesis}
% 选项
...
\input{contents/algorithm_design_and_experiments}
\input{contents/framework_and_simulation}
\input{contents/real_robot_experiments}
