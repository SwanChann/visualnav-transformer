...
|---|---|---|---|---|---|
| EfficientNet-B0 (baseline) | 12/12 (100%) | 68.0 | 6.32 m | 0.49 m | 8.7 s |

### 2.2 详细结果（按编码器 × 地图）

| 编码器 | 地图 | 调度器 | 成功率 | 步数 (mean±std) | 路径距离 (mean±std) | 终点距离 (mean±std) | 耗时 |
|---|---|---|---|---|---|---|---|
| EfficientNet-B0 (baseline) | medium | ddim-3 | 3/3 (100.0%) | 68.0±0.0 | 6.32±0.0 m | 0.49±0.0 m | 7.7 s |
| EfficientNet-B0 (baseline) | medium | ddim-3 | 3/3 (100.0%) | 68.0±0.0 | 6.32±0.0 m | 0.49±0.0 m | 8.7 s |
| EfficientNet-B0 (baseline) | medium | ddim-3 | 3/3 (100.0%) | 68.0±0.0 | 6.32±0.0 m | 0.49±0.0 m | 9.1 s |
| EfficientNet-B0 (baseline) | medium | ddim-3 | 3/3 (100.0%) | 68.0±0.0 | 6.32±0.0 m | 0.49±0.0 m | 9.2 s |
