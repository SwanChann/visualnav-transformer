...
|---|---|---|---|---|---|
| EfficientNet-B0 (baseline) | 6/6 (100%) | 99.0 | 7.77 m | 0.48 m | 8.8 s |

### 2.2 详细结果（按编码器 × 地图）

| 编码器 | 地图 | 调度器 | 成功率 | 步数 (mean±std) | 路径距离 (mean±std) | 终点距离 (mean±std) | 耗时 |
|---|---|---|---|---|---|---|---|
| EfficientNet-B0 (baseline) | hard | ddim-2 | 3/3 (100.0%) | 130.0±14.1 | 9.21±0.54 m | 0.48±0.01 m | 10.0 s |
| EfficientNet-B0 (baseline) | medium | ddim-2 | 3/3 (100.0%) | 68.0±0.0 | 6.32±0.0 m | 0.49±0.0 m | 7.5 s |
