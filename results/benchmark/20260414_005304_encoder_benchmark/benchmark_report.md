...
|---|---|---|---|---|---|---|---|
| ConvNeXt-Tiny | easy | ddim-2 | 3/3 (100.0%) | 113.0±73.0 | 8.93±4.57 m | 1.7±0.41 m | 11.5 s |
| ConvNeXt-Tiny | hard | ddim-2 | 0/3 (0.0%) | 248.3±71.7 | 18.97±3.08 m | 3.1±1.13 m | 20.7 s |
| ConvNeXt-Tiny | medium | ddim-2 | 2/3 (66.7%) | 205.0±105.3 | 12.6±4.7 m | 3.68±3.31 m | 15.5 s |
| DINOv2-Small | easy | ddim-2 | 0/3 (0.0%) | 299.0±0.0 | 17.23±0.79 m | 1.65±0.09 m | 20.8 s |
| DINOv2-Small | hard | ddim-2 | 0/3 (0.0%) | 216.3±58.6 | 16.38±2.67 m | 3.83±0.83 m | 21.7 s |
| DINOv2-Small | medium | ddim-2 | 0/3 (0.0%) | 299.0±0.0 | 18.0±0.41 m | 2.74±0.16 m | 24.7 s |
| EfficientNet-B0 (baseline) | easy | ddim-2 | 3/3 (100.0%) | 43.3±0.9 | 4.7±0.06 m | 0.32±0.07 m | 6.4 s |
| EfficientNet-B0 (baseline) | hard | ddim-2 | 2/3 (66.7%) | 91.0±29.0 | 9.2±2.29 m | 1.61±1.77 m | 10.4 s |
| EfficientNet-B0 (baseline) | medium | ddim-2 | 3/3 (100.0%) | 77.3±10.1 | 7.4±0.45 m | 0.3±0.04 m | 7.1 s |
| ResNet-50 | easy | ddim-2 | 0/3 (0.0%) | 299.0±0.0 | 19.27±2.54 m | 5.41±1.01 m | 23.8 s |
| ResNet-50 | hard | ddim-2 | 0/3 (0.0%) | 289.0±14.1 | 19.99±2.22 m | 7.41±3.73 m | 24.9 s |
| ResNet-50 | medium | ddim-2 | 0/3 (0.0%) | 299.3±0.5 | 17.45±2.74 m | 3.59±3.62 m | 24.4 s |
...
- **最佳编码器**：EfficientNet-B0 (baseline)，总成功率 89%
- **最差编码器**：DINOv2-Small，总成功率 0%

- **easy 地图最佳**：EfficientNet-B0 (baseline) (100% 成功)
- **hard 地图最佳**：EfficientNet-B0 (baseline) (67% 成功)
