...
|---|---|---|---|---|---|
| EfficientNet-B0 (baseline) | 1/3 (33%) | 47.3 | 4.58 m | 2.21 m | 13.1 s |
| DINOv2-Small | 0/3 (0%) | 49.0 | 4.86 m | 2.02 m | 16.6 s |
| ResNet-50 | 0/3 (0%) | 49.0 | 3.48 m | 4.26 m | 18.8 s |
| ConvNeXt-Tiny | 1/3 (33%) | 45.0 | 4.31 m | 2.73 m | 19.1 s |

### 2.2 详细结果（按编码器 × 地图）

| 编码器 | 地图 | 调度器 | 成功率 | 步数 (mean±std) | 路径距离 (mean±std) | 终点距离 (mean±std) | 耗时 |
|---|---|---|---|---|---|---|---|
| ConvNeXt-Tiny | easy | ddim-2 | 1/1 (100.0%) | 37.0±0.0 | 3.74±0.0 m | 1.57±0.0 m | 17.8 s |
| ConvNeXt-Tiny | hard | ddim-2 | 0/1 (0.0%) | 49.0±0.0 | 4.2±0.0 m | 4.25±0.0 m | 20.3 s |
| ConvNeXt-Tiny | medium | ddim-2 | 0/1 (0.0%) | 49.0±0.0 | 4.98±0.0 m | 2.38±0.0 m | 19.1 s |
| DINOv2-Small | easy | ddim-2 | 0/1 (0.0%) | 49.0±0.0 | 4.49±0.0 m | 0.98±0.0 m | 14.6 s |
| DINOv2-Small | hard | ddim-2 | 0/1 (0.0%) | 49.0±0.0 | 5.24±0.0 m | 2.65±0.0 m | 18.7 s |
| DINOv2-Small | medium | ddim-2 | 0/1 (0.0%) | 49.0±0.0 | 4.84±0.0 m | 2.42±0.0 m | 16.6 s |
| EfficientNet-B0 (baseline) | easy | ddim-2 | 1/1 (100.0%) | 44.0±0.0 | 4.72±0.0 m | 0.18±0.0 m | 13.4 s |
| EfficientNet-B0 (baseline) | hard | ddim-2 | 0/1 (0.0%) | 49.0±0.0 | 5.17±0.0 m | 2.68±0.0 m | 13.6 s |
| EfficientNet-B0 (baseline) | medium | ddim-2 | 0/1 (0.0%) | 49.0±0.0 | 3.85±0.0 m | 3.75±0.0 m | 12.4 s |
| ResNet-50 | easy | ddim-2 | 0/1 (0.0%) | 49.0±0.0 | 3.53±0.0 m | 2.6±0.0 m | 19.1 s |
| ResNet-50 | hard | ddim-2 | 0/1 (0.0%) | 49.0±0.0 | 3.59±0.0 m | 5.42±0.0 m | 18.5 s |
| ResNet-50 | medium | ddim-2 | 0/1 (0.0%) | 49.0±0.0 | 3.33±0.0 m | 4.75±0.0 m | 18.7 s |
...
- **最佳编码器**：EfficientNet-B0 (baseline)，总成功率 33%
- **最差编码器**：DINOv2-Small，总成功率 0%

- **easy 地图最佳**：EfficientNet-B0 (baseline) (100% 成功)
- **hard 地图最佳**：EfficientNet-B0 (baseline) (0% 成功)
- **medium 地图最佳**：EfficientNet-B0 (baseline) (0% 成功)
