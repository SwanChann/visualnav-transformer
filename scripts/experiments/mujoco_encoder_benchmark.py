...
用法：
  python scripts/experiments/mujoco_encoder_benchmark.py --runs 3 --max-steps 300
  python scripts/experiments/mujoco_encoder_benchmark.py --runs 5 --maps easy hard --schedulers ddpm ddim
"""
